...
<style>
    ...
    .sub-header { font-size: 1.2rem; color: #4a6a8c; }
    .score-large { font-size: 4rem; font-weight: 700; text-align: center; }
    .score-red { color: #dc3545; }
    .score-orange { color: #fd7e14; }
    .score-green { color: #28a745; }
    .card { background: #f8f9fa; border-radius: 10px; padding: 20px; margin: 10px 0; }
</style>
